...
dependencies {
        implementation 'com.github.NivixX.NDatabase:ndatabase-api:0.5.0'
}
```
...
| computeTop(topK, *comparator*) | ❌    | ✔️    | Stream all your entities and compute a top, useful for doing ranking (for example `.computeTopAsync(10, (o1, o2) -> o2.getScore() - o1.getScore())` to return top10 by score)                                                                                                                                                                                                                                                                                                                     |
